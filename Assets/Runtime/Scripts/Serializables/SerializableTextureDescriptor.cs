//-------------------------------------------------------------------------------------------------------
// <copyright file="SerializableTextureDescriptor.cs" createdby="gblikas">
// 
// XR Remote
...
namespace XRRemote.Serializables 
{
    ...
    public struct SerializableTextureDescriptor : IEquatable<SerializableTextureDescriptor>
    {
        ...
        public SerializableTextureDescriptor(Texture2D tex, int propertyNameId)
        {
        ...
        public static implicit operator SerializableTextureDescriptor(XRTextureDescriptor d)
        {
            var union = new TextureDescriptorUnion()
            {
                b = d,
